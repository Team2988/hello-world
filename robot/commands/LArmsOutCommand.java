...
public class LArmsOutCommand extends Command {
	private boolean done = false;
	private ArmSubsystem armSubsystem;

	public LArmsOutCommand() {
	...
	protected void execute() {
		...
		armSubsystem.LarmRotate((armSubsystem.leftSwitch()) ? 0 : .5);
	...
	protected boolean isFinished() {
		return done; //|| armSubsystem.leftSwitchActivated();
	}
